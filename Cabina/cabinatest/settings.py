"""
Django settings for cabinatest project.
...
WSGI_APPLICATION = 'cabinatest.wsgi.application'
...
DOJ_BUILDWAR_JAVA_LIBS = [
    ...
    os.path.join(BASE_DIR, 'libs', 'Verificacion-2.1.2.jar'),
